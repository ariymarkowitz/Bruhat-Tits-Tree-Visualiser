...
This is a visualiser of the Bruhat-Tits tree over $\mathbb{Q}_p$, and the action of $\mathrm{GL}(2, \mathbb{Q}_p)$ on the tree.
...
$$
u_{-m} p^{-m} + u_{-m+1} p^{-m+1} + \dots + u_{n-1} p^{n-1}.
$$
